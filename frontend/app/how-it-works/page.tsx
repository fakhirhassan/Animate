  ...
  return (
    <div ref={ref} className="relative">
      ...
      {index < timelineSteps.length - 1 && (
        <motion.div
          className="absolute left-8 top-20 w-0.5 h-full bg-gradient-to-b from-blue-500 to-purple-500"
      ...
      <div className="flex gap-8 mb-16 md:mb-24">
        ...
        <motion.div
          ...
          className="flex-1"
        >
          <div className="bg-white/80 backdrop-blur-sm border border-gray-200 rounded-2xl p-8 hover:shadow-xl transition-shadow duration-300">
            {/* Icon */}
            <motion.div
                  ...
                  return (
                    ...
                    >
                      <div className="w-8 h-8 rounded-lg bg-blue-50 flex items-center justify-center flex-shrink-0">
                        <SubIcon className="h-4 w-4 text-blue-500" />
                      </div>
...
function TwoDToThreeDSection() {
  ...
  return (
    <motion.div
      ...
      className="relative bg-gradient-to-br from-blue-50 to-purple-50 border-2 border-blue-200 rounded-3xl p-8 md:p-12"
    >
      {/* Badge */}
      ...
      <div className="text-center">
        <Link href="/creator/2d-to-3d">
          <Button className="bg-gradient-to-r from-blue-500 to-purple-500 hover:from-blue-600 hover:to-purple-600 text-white px-8">
            Try Now
